...
### 2. The Puzzle Image
- A newly AI-generated, aesthetically elephant illustration (similar style to the reference image — whimsical, colorful, classroom-friendly) used as the puzzle background
- The image will be generated and embedded as a static asset
...
- True jigsaw-style piece segmentation with drag-and-drop on desktop and touch-drag on mobile
...
- Set difficulty level (Easy / Medium / Hard / Very Hard — affects number of puzzle pieces or time limits)
